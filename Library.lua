	...
	function Window:AddTab(...)
		...
		function Tab:UpdateWarningBox(Info)
			...
			if typeof(Info.Color) == "Color3" then
				Tab.WarningBox.Color = Info.Color
			end

			local color = Tab.WarningBox.Color or Color3.fromRGB(255, 50, 50)
			local darker = Color3.new(color.R * 0.4, color.G * 0.4, color.B * 0.4)
			...
			if Tab.WarningBox.IsNormal then
				WarningBox.BackgroundColor3 = Library.Scheme.BackgroundColor
				WarningBox.BorderColor3 = Library.Scheme.OutlineColor
				WarningTitle.TextColor3 = Library.Scheme.FontColor
				WarningStroke.Color = Library.Scheme.OutlineColor
			else
				WarningBox.BackgroundColor3 = Library:GetDarkerColor(color)
				WarningBox.BorderColor3 = color
				WarningTitle.TextColor3 = color
				WarningStroke.Color = darker
			end
			...
			Library.Registry[WarningBox].BackgroundColor3 = function()
				return Tab.WarningBox.IsNormal and Library.Scheme.BackgroundColor or Library:GetDarkerColor(color)
			end
			Library.Registry[WarningBox].BorderColor3 = function()
				return Tab.WarningBox.IsNormal and Library.Scheme.OutlineColor or color
			end
			Library.Registry[WarningTitle].TextColor3 = function()
				return Tab.WarningBox.IsNormal and Library.Scheme.FontColor or color
			end
			Library.Registry[WarningStroke].Color = function()
				return Tab.WarningBox.IsNormal and Library.Scheme.OutlineColor or darker
			end
		end
